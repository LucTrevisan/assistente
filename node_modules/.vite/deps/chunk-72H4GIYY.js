...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-BLLLKQT7.js").then((module) => this._dumpTools = module);
    }
...
var PassCubePostProcess = class _PassCubePostProcess extends PostProcess {
   ...
   */
  constructor(name, options, camera = null, samplingMode, engine, reusable, textureType = 0, blockCompilation = false) {
    super(name, "passCube", null, null, options, camera, samplingMode, engine, reusable, "#define POSITIVEX", textureType, void 0, null, blockCompilation);
    this._face = 0;
  }
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(Promise.all([import("./passCube.fragment-QJLUAXOO.js")]));
    } else {
...
//# sourceMappingURL=chunk-72H4GIYY.js.map
