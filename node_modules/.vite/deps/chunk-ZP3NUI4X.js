...
var FlowGraphBlock = class {
  ...
  registerDataInput(name, richType) {
    const input = new FlowGraphDataConnection(name, 0, this, richType);
  ...
  registerDataOutput(name, richType) {
    const output = new FlowGraphDataConnection(name, 1, this, richType);
    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./pbr.vertex-2WM3DR4W.js"), import("./pbr.fragment-5NIVHQK3.js")]);
        } else {
          await Promise.all([import("./pbr.vertex-U7LMDFRH.js"), import("./pbr.fragment-7FCLEVCF.js")]);
        }
...
//# sourceMappingURL=chunk-ZP3NUI4X.js.map
