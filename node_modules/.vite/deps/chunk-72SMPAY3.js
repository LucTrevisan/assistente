...
var RGBDTextureTools = class {
  ...
  static ExpandRGBDTexture(texture) {
    ...
    const expandRGBDTexture = async () => {
      ...
      internalTexture.isReady = false;
      if (isWebGPU) {
        await Promise.all([import("./rgbdDecode.fragment-FCHCBUKV.js"), import("./rgbdEncode.fragment-7ENSFBBI.js")]);
      } else {
        await Promise.all([import("./rgbdDecode.fragment-V6UPKNP3.js"), import("./rgbdEncode.fragment-J65Z4O3W.js")]);
      }
...
async function UploadLevelsAsync(texture, imageData, imageType = DefaultEnvironmentTextureImageType) {
  ...
  if (expandTexture) {
    if (engine.isWebGPU) {
      shaderLanguage = 1;
      await import("./rgbdDecode.fragment-FCHCBUKV.js");
    } else {
      await import("./rgbdDecode.fragment-V6UPKNP3.js");
    }
...
//# sourceMappingURL=chunk-72SMPAY3.js.map
