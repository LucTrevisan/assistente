import {
  ...
  SpotLight,
  WeightedSound
} from "./chunk-ZP3NUI4X.js";
import "./chunk-QDXIFF52.js";
import "./chunk-72SMPAY3.js";
import "./chunk-CPDKSKLF.js";
import {
  RenderTargetTexture,
  SphericalHarmonics,
  SphericalPolynomial
} from "./chunk-72H4GIYY.js";
import {
  AbstractMesh,
  BoundingInfo,
  Camera,
...
} from "./chunk-OROYX4KI.js";
import "./chunk-AVFKFWTO.js";
import {
  Animation,
  Bone
} from "./chunk-UURGRTOV.js";
import "./chunk-FC3JEBT4.js";
import "./chunk-6DQSAGKY.js";
import "./chunk-TFMSJVI2.js";
import "./chunk-L5S27I2L.js";
import "./chunk-WIZK3OBH.js";
import {
  Texture
} from "./chunk-QEB42RLQ.js";
import "./chunk-5NINHHID.js";
import {
  Color3,
  Color4
} from "./chunk-MKQYVJ4Z.js";
import {
  Matrix,
  Quaternion,
  TmpVectors,
  ...
  Vector3,
  Vector4
} from "./chunk-4F2ZRFTA.js";
import "./chunk-AH7AAYCM.js";
import "./chunk-24UO7VO7.js";
import {
  Tools
} from "./chunk-UP4CJE6O.js";
import "./chunk-EQ2RUIWM.js";
import {
  Buffer,
  VertexBuffer
} from "./chunk-TCHRIN6N.js";
...
import {
  ...
  RandomGUID,
  RuntimeError
} from "./chunk-UMJJLGSP.js";
import "./chunk-LMH7SWDS.js";
import "./chunk-QS7N3A43.js";
import "./chunk-I2PO3XEU.js";
import {
  Effect
} from "./chunk-77UHS4C3.js";
import {
  Observable
} from "./chunk-6CWVG6RN.js";
import {
  Logger
} from "./chunk-YQ3KT7UQ.js";
...
var GLTFLoader2 = class _GLTFLoader {
  ...
  loadAnimationAsync(context, animation) {
    ...
    return import("./animationGroup-LATQ6YUG.js").then(({ AnimationGroup }) => {
      this._babylonScene._blockEntityCollection = !!this._assetContainer;
...
registerGLTFExtension(NAME6, true, (loader) => new KHR_draco_mesh_compression(loader));
...
registerGLTFExtension(NAME7, true, (loader) => new KHR_lights(loader));
...
registerGLTFExtension(NAME8, true, (loader) => new KHR_materials_pbrSpecularGlossiness(loader));
...
registerGLTFExtension(NAME9, true, (loader) => new KHR_materials_unlit(loader));
...
registerGLTFExtension(NAME10, true, (loader) => new KHR_materials_clearcoat(loader));
...
registerGLTFExtension(NAME11, true, (loader) => new KHR_materials_iridescence(loader));
...
registerGLTFExtension(NAME12, true, (loader) => new KHR_materials_anisotropy(loader));
...
registerGLTFExtension(NAME13, true, (loader) => new KHR_materials_emissive_strength(loader));
...
registerGLTFExtension(NAME14, true, (loader) => new KHR_materials_sheen(loader));
...
registerGLTFExtension(NAME15, true, (loader) => new KHR_materials_specular(loader));
...
registerGLTFExtension(NAME16, true, (loader) => new KHR_materials_ior(loader));
...
registerGLTFExtension(NAME17, true, (loader) => new KHR_materials_variants(loader));
...
registerGLTFExtension(NAME18, true, (loader) => new KHR_materials_transmission(loader));
...
registerGLTFExtension(NAME19, true, (loader) => new KHR_materials_diffuse_transmission(loader));
...
registerGLTFExtension(NAME20, true, (loader) => new KHR_materials_volume(loader));
...
registerGLTFExtension(NAME21, true, (loader) => new KHR_materials_dispersion(loader));
...
registerGLTFExtension(NAME22, true, (loader) => new KHR_mesh_quantization(loader));
...
registerGLTFExtension(NAME23, true, (loader) => new KHR_texture_basisu(loader));
...
registerGLTFExtension(NAME24, true, (loader) => new KHR_texture_transform(loader));
...
registerGLTFExtension(NAME25, true, (loader) => new KHR_xmp_json_ld(loader));
...
registerGLTFExtension(NAME26, true, (loader) => new KHR_animation_pointer(loader));
...
registerGLTFExtension(NAME27, true, (loader) => new MSFT_audio_emitter(loader));
...
var MSFT_lod = class {
  ...
  constructor(loader) {
    ...
    this._loader = loader;
    this.maxLODsToLoad = ((_a = this._loader.parent.extensionOptions[NAME28]) == null ? void 0 : _a.maxLODsToLoad) ?? this.maxLODsToLoad;
...
registerGLTFExtension(NAME28, true, (loader) => new MSFT_lod(loader));
...
registerGLTFExtension(NAME29, true, (loader) => new MSFT_minecraftMesh(loader));
...
registerGLTFExtension(NAME30, true, (loader) => new MSFT_sRGBFactors(loader));
...
registerGLTFExtension(NAME31, true, (loader) => new KHR_interactivity(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_node_visibility.js
var NAME32 = "KHR_node_visibility";
var KHR_node_visibility = class {
  ...
  constructor(loader) {
    this.name = NAME32;
    this._loader = loader;
    this.enabled = loader.isExtensionUsed(NAME32);
  }
  async onReady() {
    var _a;
...
registerGLTFExtension(NAME32, true, (loader) => new KHR_node_visibility(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/ExtrasAsMetadata.js
var NAME33 = "ExtrasAsMetadata";
...
registerGLTFExtension(NAME33, false, (loader) => new ExtrasAsMetadata(loader));
export {
  __exports as GLTF1,
  __exports2 as GLTF2,
  GLTFFileLoader,
