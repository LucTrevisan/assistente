...
import {
  LightConstants
} from "./chunk-TFMSJVI2.js";
import {
  Axis
} from "./chunk-L5S27I2L.js";
import {
  Frustum,
  SmartArray
} from "./chunk-WIZK3OBH.js";
import {
  Texture,
      ...
      let effect = scene.getEngine().createEffect(shaderName, {
        ...
        extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
          if (this._shaderLanguage === 1) {
            await Promise.all([import("./default.vertex-AGHUQKL2.js"), import("./default.fragment-4E7ISAJU.js")]);
          } else {
            await Promise.all([import("./default.vertex-6N6APP6Y.js"), import("./default.fragment-6UVF4VDC.js")]);
          }
...
function appendSceneAsyncCore(rootUrl, sceneFilename, scene, onProgress, pluginExtension, name, pluginOptions) {
  return new Promise((resolve, reject) => {
    appendAsync(rootUrl, sceneFilename, scene, (scene2) => {
      resolve(scene2);
    }, onProgress, (scene2, message, exception) => {
      reject(exception || new Error(message));
    }, pluginExtension, name, pluginOptions);
...
function importAnimations(rootUrl, sceneFilename = "", scene = EngineStore.LastCreatedScene, overwriteAnimations = true, animationGroupLoadingMode = 0, targetConverter = null, onSuccess = null, onProgress = null, onError = null, pluginExtension = null, name = "", pluginOptions = {}) {
  if (!scene) {
...
//# sourceMappingURL=chunk-OROYX4KI.js.map
